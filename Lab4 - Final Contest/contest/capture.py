...
def read_command(argv):
    ...
    parser.add_option('-b', '--blue', help=default('Blue team'), default=os.path.join(DIR_SCRIPT, 'agents/FINAL_TEAM/myTeam')),
    ...
    parser.add_option('--delay-step', type='float', dest='delay_step',
                      help=default('Delay step in a play or replay.'), default=0)
